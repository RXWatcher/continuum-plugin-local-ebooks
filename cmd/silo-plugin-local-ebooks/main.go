// Command silo-plugin-local-ebooks is the plugin entrypoint.
package main
...
import (
	...
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/grpc/ebookbackend"
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/grpc/metadataprovider"
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/httproutes"
	...
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/migrate"
	pluginrt "github.com/RXWatcher/silo-plugin-local-ebooks/internal/runtime"
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/scanner"
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/scheduler"
	"github.com/RXWatcher/silo-plugin-local-ebooks/internal/server"
...
func main() {
	logger := hclog.New(&hclog.LoggerOptions{Name: "silo-plugin-local-ebooks"})
	...
	configureMetadata := func(p *pgxpool.Pool, st *store.Store, appCfg store.AppConfig) {
		ua := "silo-local-ebooks/" + manifest.GetVersion()
